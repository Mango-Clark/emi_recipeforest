...
public final class EmiCompatibility {
    ...
    public static final String SUPPORTED_RANGE = "1.1.13+1.20.1 through 1.1.24+1.20.1";

    private static final Pattern SUPPORTED_VERSION = Pattern.compile(
            "^1\\.1\\.(\\d+)\\+1\\.20\\.1(?:\\+[0-9A-Za-z][0-9A-Za-z._-]*)*$");
     ...
     * @return whether the version belongs to the supported 1.20.1 range
     */
